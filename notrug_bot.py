...
async def check_hundred(context, tid):
    ...
    if user[10] >= REQUIRED_POINTS and not user[11]:
        ...
        await context.bot.send_message(
            chat_id=tid,
            text=(
                "$NOTRUG Airdrop — Congratulations! 🎉\n\n"
                "You reached 100 points!\n"
                "You qualify for 10,000 $NOTRUG!\n\n"
                "━━━━━━━━━━━━━━━━━━━━\n"
                "Please send your Phantom wallet address.\n"
                "$NOTRUG will be sent to this address.\n\n"
                "Solana network — Phantom wallet:\n"
                "Download free at phantom.app\n\n"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "auto_wallet":
        ...
        rank = get_rank(tid)
        await update.message.reply_text(
            "$NOTRUG Airdrop — Complete! 🎉\n\n"
            "Your wallet address has been received.\n"
            "10,000 $NOTRUG will be sent to your\n"
            "Phantom wallet within 1-2 hours!\n\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "Keep earning points for Top 5! 🏆\n\n"
            "Your rank: #" + str(rank) + "\n\n"
            "Top 5 users get an additional\n"
            "+10,000 $NOTRUG BONUS at launch day!\n\n"
            "Keep going:\n"
            "Daily group message → +10pts\n"
            "Invite friends → +10pts each\n"
            "Comment on new tweets → +10pts each"
        )
        await context.bot.send_message(
            chat_id=ADMIN_ID,
            text=(
