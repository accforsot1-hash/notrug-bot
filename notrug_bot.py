    ...
    if user[10] >= REQUIRED_POINTS and not user[11]:
        ...
        await context.bot.send_message(
            ...
            text=(
                ...
                "━━━━━━━━━━━━━━━━━━━━\n"
                "Lutfen Phantom cuzdan adresini gonder.\n"
                "NOTRUG bu adrese yollanacak.\n\n"
                "Solana aginda Phantom cuzdan adresi:\n"
                "(phantom.app uzerinden ucretsiz olusturabilirsin)\n\n"
                "Adresini buraya gonder:"
            )
        )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "auto_wallet":
        ...
        await update.message.reply_text(
            ...
            "Wallet adresin kaydedildi:\n"
            + wallet[:20] + "...\n\n"
            "10,000 NOTRUG 1-2 saat icinde\n"
            "Phantom cüzdanına tanımlanacak!\n\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "Halen puan kazanabilirsin!\n\n"
            "Rank: #" + str(rank) + "\n"
            "Top 5e girersen launch günü\n"
            "ekstra +10,000 NOTRUG bonus kazanırsın! 🏆\n\n"
            "Günlük grup mesajı at, arkadaş davet et,\n"
            "yeni tweetlere yorum yap ve puan kaslamaya devam et!"
        )
        await context.bot.send_message(
            chat_id=ADMIN_ID,
            text=(
...
# ==================== COMMANDS ====================
# wallet_cmd removed - wallet is collected automatically at 100 points
